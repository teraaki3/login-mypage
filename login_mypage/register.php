    ...
    <form action="register_confirm.php" method="post" enctype="multipart/form-data">
      <div class="form_contents">
        ...
        <div class="password">
          ...
          <input type="password" class="formbox" size="40" name="confirm_pasword" id="confirm" oninput="ConfirmPassword(this)" required>
        </div>
        <div class="picture">
        ...
        <div class="toroku">
          <input type="submit" class="submit_button" size="35" valu="登録する">
        </div>
      </div>
    </form>
  </main>
